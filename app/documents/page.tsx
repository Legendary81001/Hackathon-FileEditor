...
const documents: DocumentItem[] = [
  {
    ...
    description:
      "A shared view of the product foundations and what comes next.",
    edited: "Edited 18 minutes ago",
    section: "Product",
    accent: "bg-[#dce6d9]",
    collaborators: ["AM", "JK", "TR"],
  },
  {
    id: "2",
    title: "Hackathon Ideas",
    description:
      "Loose thoughts, useful sparks, and the ideas worth prototyping.",
  ...
  },
  {
    ...
    description:
      "Patterns from user conversations and observations in the wild.",
    edited: "Edited 3 days ago",
    section: "Research",
    accent: "bg-[#d8e5e2]",
    collaborators: ["JK", "TR", "NP", "AM"],
  },
  {
    id: "4",
    title: "Team Meeting — September",
    description:
      "Decisions, open questions, and a short list of next actions.",
    edited: "Edited Sep 12",
    section: "Team",
    accent: "bg-[#e9dedb]",
    collaborators: ["LS", "NP"],
  },
    ...
    <main className="min-h-screen bg-[#f7f8f3] text-[#17211b]">
        ...
        <div className="mx-auto flex h-[76px] max-w-7xl items-center justify-between px-6 sm:px-10 lg:px-16">
          ...
          >
            ...
            <span className="text-[17px] font-semibold tracking-[-0.025em]">
              synora
              <span className="text-[#db5a3c]">.</span>
            </span>
          </Link>
      ...
      <div className="mx-auto max-w-7xl px-6 pb-16 pt-12 sm:px-10 lg:px-16 lg:pt-16">
        <div className="flex flex-col justify-between gap-8 border-b border-[#dfe5dc] pb-9 md:flex-row md:items-end">
          <div>
            <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.22em] text-[#db5a3c]">
              Your workspace
            </p>
        ...
        <div className="flex flex-col justify-between gap-5 py-7 sm:flex-row sm:items-center">
          <div className="relative w-full sm:max-w-[340px]">
            ...
            <span className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-[#8a968b]">
              <SearchIcon />
            </span>
        ...
        {filteredDocuments.length > 0 ? (
          ...
          <div className="rounded-[1.15rem] border border-dashed border-[#cbd7c8] bg-[#eef3eb] px-6 py-16 text-center">
            <p className="font-semibold text-[#304833]">
              No documents found
            </p>

            <p className="mt-2 text-sm text-[#718075]">
              Try a different title or section.
            </p>
          </div>
        )}
